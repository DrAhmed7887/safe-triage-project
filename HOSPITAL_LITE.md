...
- Service worker / proper PWA queue-sync. The current behaviour is
  best-effort offline fallback per request, which is enough for the
  demo and honest about its limits.
