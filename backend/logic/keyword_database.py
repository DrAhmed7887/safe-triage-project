    ...
    "level_2": {
        "chest_pain_cardiac": {
            "keywords": [
                ...
                "خفقان", "قلبي هيقف", "صدره بيوجعه", "باين عليه تعبان",
        ...
        "silent_mi": {
            "keywords": [
                ...
                "هبطان ومعدتي مقلوبة", "معدتي مقلوبة", "عرقان تلج", "عرق تلج",
        ...
        "stroke_symptoms": {
            "keywords": [
                ...
                "نص جسمه", "ايده مش بتتحرك", "بيشوف ضلم",
        ...
        "respiratory_distress": {
            "keywords": [
                ...
                "عندها ربو", "عنده ربو", "مش قادرة تتنفس",
