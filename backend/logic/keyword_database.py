...
DEFAULT_KEYWORDS = {
    ...
    "level_2": {
        ...
        "suicidal_homicidal": {
            "keywords": ["suicidal", "kill myself", "عايز أموت", "عايز يموت",
                        ...
                        "هيأذي نفسه", "مش عايز يعيش", "انتحار"],
            "added_by_ai": [],
            "priority": 2
        },
        "obstetric_emergency": {
    ...
    "level_3": {
        ...
        "moderate_bleeding": {
            "keywords": ["bleeding", "بينزف", "نزيف", "دم", "جرح بينزف"],
            "added_by_ai": [],
            "priority": 3
        },
        "fracture_deformity": {
