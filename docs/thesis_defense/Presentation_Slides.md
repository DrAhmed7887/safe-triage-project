...
1. Title: SAFE-Triage – AI-Powered Emergency Triage for Egyptian Hospitals
...
10. MedGemma QA via Dr7.ai hosted API (async review)
11. Alerts (FCM Push + Email)
12. Validation: 138 scenarios, zero under-triage
13. Performance: cold start 0.45s
14. Case Study: Chest pain → ESI 2 (SNOMED 225566008, ICD-10 I20.9)
